            ...
            <div class="layer-meta">
              ...
              <div class="op-row">
                <input
                  ...
                  @change="saveHistory()"
                />
                <span class="op-val">{{ layer.opacity }}%</span>
              </div>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div class="bp-sliders">
          <div class="bp-row">
            ...
            <span class="bp-val">{{ lineWidth }}</span>
          </div>
          <div class="bp-row">
            ...
            <span class="bp-val">{{ strokeOpacity }}%</span>
          </div>
        </div>
      </FloatingPopup>
      ...
      >
        ...
        <div class="bp-sliders">
          <div class="bp-row">
            ...
            <span class="bp-val">{{ wandTolerance }}</span>
          </div>
        </div>
      </FloatingPopup>
      ...
      >
        ...
        <div class="bp-sliders">
          <div class="bp-row">
            ...
            <span class="bp-val">{{ fontSize }}</span>
          </div>
          <div class="bp-row">
            <span class="bp-label">{{ t('opacity') }}</span>
            <input type="range" min="0" max="100" v-model.number="strokeOpacity" class="bp-slider" @mousedown.stop @touchstart.stop />
      ...
      >
        ...
        <div style="display:flex;flex-direction:column;gap:8px">
          ...
          <div v-if="exportFormat === 'jpg' || exportFormat === 'webp'" class="ep-quality">
            ...
            <span class="ep-val">{{ exportQuality }}%</span>
          </div>
